...
public abstract class VkAbstractMap<K, V> implements Map<K, V> {

	/**
	 * Sole constructor. (For invocation by subclass constructors, typically
	 * implicit.)
	 */
	protected VkAbstractMap() {
	}
	 ...
	 */
	public transient volatile Set<K> keySet;
	public transient volatile Collection<V> values;
	...
	public Set<K> keySet() {
		if (keySet == null) {
			keySet = new AbstractSet<K>() {
				...
				@Override
				public int size() {
					return VkAbstractMap.this.size();
				}

				@Override
				public boolean isEmpty() {
					return VkAbstractMap.this.isEmpty();
				}

				@Override
				public void clear() {
					VkAbstractMap.this.clear();
				}

				@Override
				public boolean contains(Object k) {
					return VkAbstractMap.this.containsKey(k);
				}
			};
		}
		return keySet;
		...
		if (values == null) {
			values = new AbstractCollection<V>() {
				...
				public boolean contains(Object v) {
					return VkAbstractMap.this.containsValue(v);
				}
			};
		}
		return values;
	...
	/**
	 * Returns a shallow copy of this <tt>UebAbstractMap</tt> instance: the keys
	...
	protected Object clone() throws CloneNotSupportedException {
		VkAbstractMap<?, ?> result = (VkAbstractMap<?, ?>) super.clone();
		result.keySet = null;
		result.values = null;
		return result;
	}
