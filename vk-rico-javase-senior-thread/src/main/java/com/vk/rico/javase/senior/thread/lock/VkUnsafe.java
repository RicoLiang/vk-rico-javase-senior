...
public final class VkUnsafe {

	private static native void registerNatives();

	static {
		registerNatives();
		sun.reflect.Reflection.registerMethodsToFilter(VkUnsafe.class, "getUnsafe");
	}

	private VkUnsafe() {
	}

	private static final VkUnsafe theUnsafe = new VkUnsafe();
	 ...
	 * element within the given object <code>o</code> at the given
	 * <code>offset</code>.
	 *
	 * @param o
